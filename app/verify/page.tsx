        ...
        {isVerified ? (
          ...
          <>
            <Card className="w-full p-5 bg-gray-900/80 mb-6">
              ...
              <div className="bg-blue-900/20 border border-blue-800/30 rounded-md p-4 mb-4">
                ...
                <p className="text-sm text-gray-300 mb-3">
                  Verified users receive a personalized handle (@username) instead of using a chain address. This makes
                  it easier for others to recognize and interact with you in the network.
                </p>
            ...
            <Card className="w-full p-4 bg-blue-900/20 border border-blue-800/30">
              ...
              <p className="text-xs text-gray-400">
                The verification is processed by decentralized oracles and your data never leaves your device
                unencrypted.
              </p>
            </Card>
          </>
