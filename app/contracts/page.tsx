...
// Memoized sidebar content component to prevent unnecessary re-renders
const SidebarContent = memo(({ onTabChange }: { onTabChange: (tab: string) => void }) => (
  <div className="space-y-4 px-2">
    ...
    <div className="space-y-2">
      <div className="text-xs bg-gray-800 p-2 rounded-md cursor-pointer hover:bg-gray-700">Contract Writing Guide</div>
      <div className="text-xs bg-gray-800 p-2 rounded-md cursor-pointer hover:bg-gray-700">Security Best Practices</div>
...
// Memoized right panel content component
...
BuildTabContent.displayName = "BuildTabContent"
...
DeployTabContent.displayName = "DeployTabContent"
...
export default function ContractsPage() {
  ...
  // Effect to listen for sidebar collapse/expand events
  useEffect(() => {
  ...
  return (
    <DesktopLayout
      sidebar={isDesktop ? <SidebarContent onTabChange={handleTabChange} /> : undefined}
